...
const ServerChannel: FC<ServerChannelProps> = ({ channel, server, role }) => {
    ...
    return (
        ...
        >
            ...
            <p className={cn("line-clamp-1 font-semibold text-sm text-zinc-500 group-hover:text-zinc-500 dark:text-zinc-400 dark:group-hover:text-zinc-300 transition",
