...
const ChatItem: FC<ChatItemProps> = ({
    content, currentMember, deleted, fileUrl,
    id, isUpdated, member, socketQuery, socketUrl, timestamp
}) => {
    ...
    const isModetarot = currentMember.role === MemberRole.MODERATOR;

    const isOwner = currentMember.id === member.id
    const canDeleteMessage = !deleted && (isAdmin || isModetarot || isOwner)
            ...
            <div className='flex flex-col w-full'>
                ...
                {isPDF && (
                    <div className="relative flex items-center p-2 mt-2 rounded-md bg-background/10">
                        ...
                        <a href={fileUrl} target="_blank" rel="noopener noreferrer" className="max-w-xs ml-2 text-sm text-indigo-500 dark:text-indigo-400 hover:underline">
                            PDF File
                        </a>
                    </div>
                )}
